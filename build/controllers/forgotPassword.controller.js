...
var _PasswordReset = _interopRequireDefault(require("../models/PasswordReset.js"));
var _emailService = require("../libs/emailService.js");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          resetCode = _crypto["default"].randomBytes(4).toString('hex');
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var token, newPassword, confirmNewPassword, resetEntry, expirationTime, currentTime, user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          if (!(newPassword.length <= _config.LENGTH_PASSWORD || !/\d/.test(newPassword))) {
            _context2.next = 6;
            break;
          }
        ...
        case 13:
          ...
          expirationTime = 20 * 60 * 1000; // 20 minutos en milisegundos
        ...
        case 19:
          _context2.next = 21;
          return _User["default"].findById(resetEntry.userId);
        case 21:
          user = _context2.sent;
          if (user) {
            _context2.next = 24;
