...
var uploadProfileImage = exports.uploadProfileImage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var oldImageUrl, newImageFileName, userId, oldImagePath;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          oldImageUrl = req.user.profileImage;
        ...
        case 6:
          if (oldImageUrl) {
            oldImagePath = _path["default"].join(__dirname, '..', '..', 'uploads', 'profileImage', oldImageUrl);
            _fs["default"].unlinkSync(oldImagePath);
          }
          res.json({
            newImageFileName: newImageFileName,
            message: "La imagen de perfil se actualizo correctamente."
          });
          _context.next = 14;
          break;
        case 10:
          ...
          console.error('Error al subir la imagen de perfil:', _context.t0);
          res.status(500).json({
  ...
  return function uploadProfileImage(_x, _x2) {
